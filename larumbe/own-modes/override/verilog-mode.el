...
(defconst verilog-mode-version "2020-03-24-0d62192-vpo"
  ...
  (setq verilog-font-lock-keywords-3
        (append verilog-font-lock-keywords-2
                ...
                (list
                 ...
                 ;; These are regexps inherited from the ones at imenu regexps but simplified since some buffers seemed not to parse them randomly (maybe because of complexity). However, the ones at imenu and `C-M-d' are recognized at regexp-builder
