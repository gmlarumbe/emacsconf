...
echo "LIBS=$LIBS"
export JSON_CFLAGS JSON_LIBS LDFLAGS CPPFLAGS LIBS
...
echo ""
./configure --prefix=$PREFIX --with-gif=ifavailable --with-native-compilation --with-json | tee $LOG_FILE
RC=$?
