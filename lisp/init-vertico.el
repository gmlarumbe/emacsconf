...
(use-package consult
  ...
  (defun larumbe/consult-symbol-at-point ()
    ...
    (let* (
           ...
           (initial-input (concat "\\_<" sym-atp ".?\\_>")) ; TODO: This one matches symbol and symbol ended in symbol+anything (e.g: use-package and use-packages)
           ;; (initial-input (concat "\\_<" sym-atp "\\_>.?")) ; TODO: This one doesn't match match at the end of the line
