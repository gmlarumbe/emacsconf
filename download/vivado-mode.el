...
(defvar vivado_keywords
      '(("\\<\\(get_files\\|get_clocks\\|get_cells\\|get_pins\\|get_ports\\|get_nets\\)\\>" . font-lock-keyword-face)
        ...
        ;; ;; DANGER: Added by Larumbe. Check following lines: -> FIXME: Not necessary once it has been defined as a derived tcl-mode with its keywords
        ;; ;;   /usr/share/emacs/25.1/lisp/progmodes/tcl.el.gz:207
        ;; ;;   /usr/share/emacs/25.1/lisp/progmodes/tcl.el.gz:519
...
(define-derived-mode vivado-mode tcl-mode
  (font-lock-add-keywords 'vivado-mode vivado_keywords) ; Modified to preserve tcl-keywords
